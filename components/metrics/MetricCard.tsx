...
export function MetricCard({ title, value, previousValue, format = "number", caption, variant = 'default', Icon }: MetricCardProps) {
  ...
  return (
    <Card className={`bg-white/60 backdrop-blur-lg border border-white/30 dark:border-zinc-800/90 dark:shadow-md dark:shadow-black/30 shadow-md rounded-2xl p-4 flex items-stretch `}>
